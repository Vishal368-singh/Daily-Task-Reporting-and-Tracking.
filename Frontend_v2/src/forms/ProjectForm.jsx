...
const ProjectForm = ({ onAdd, initialData, onUpdate, onCancel }) => {
  ...
  return (
    <form
      ...
      className="bg-[#2a2a2a] p-6 rounded-2xl shadow-md flex flex-col max-h-[90vh]"
    >
      <h3 className="text-lg font-semibold text-white text-center mb-4 flex-shrink-0">
        {initialData ? "Update Project" : "Add Project"}
      </h3>

      <div className="flex-grow overflow-y-auto pr-2 flex flex-col gap-5">
        {/* Project Name */}
