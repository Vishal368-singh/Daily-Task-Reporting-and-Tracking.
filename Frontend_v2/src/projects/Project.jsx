  ...
  return (
    <div className="p-6">
      ...
      {(isModalOpen || editingProject) && (
        // Add z-50 to this line to ensure it renders above all other page content.
        <div className="fixed inset-0 bg-black/60 flex justify-center overflow-y-auto p-8 z-50">
          <div className="w-11/12 md:w-2/3 lg:w-1/2 my-auto">
            <ProjectForm
